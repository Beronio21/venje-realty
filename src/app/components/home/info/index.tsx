...
export default function CompanyInfo() {
  const stats = [
    ...
    { value: "₱2.5B", label: "Total Sales", icon: (
  ...
  return (
    <section className="py-16 bg-primary dark:bg-emerald-900">
      <div className="container lg:max-w-screen-xl md:max-w-screen-md mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {stats.map((stat, i) => (
            <div key={i} className="flex flex-col items-center text-center group" data-aos={i === 0 ? "fade-right" : i === 1 ? "fade-up" : "fade-left"}>
