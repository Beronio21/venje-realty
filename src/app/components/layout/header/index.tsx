        ...
        <div className="flex items-center space-x-4">
          ...
          {user?.user || session?.user ? (
            ...
            <>
              ...
              <Link
                href="/signup"
                className="hidden lg:block bg-primary text-white px-4 py-2 rounded-lg hover:bg-emerald-700"
              >
                Sign Up
              </Link>
            </>
          ...
          <div className="mt-4 flex flex-col space-y-4 w-full">
            {user?.user || session?.user ? (
              ...
              <>
                ...
                <Link
                  href="/signup"
                  className="bg-primary text-white px-4 py-2 rounded-lg hover:bg-emerald-700"
                  onClick={() => {
                    setNavbarOpen(false);
                  }}
                >
