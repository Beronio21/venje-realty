...
const Footer = () => {
  ...
  return (
    <footer className="relative z-10 bg-[#052e16] dark:bg-[#021a0d]">
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="md:col-span-8 col-span-12 grid grid-cols-12 gap-4 px-4 sm:px-0">
            <div className="w-full lg:col-span-4 col-span-12">
              <h4 className="mb-4 text-lg text-emerald-400 dark:text-emerald-400">
                Address
              </h4>
              <p className="mb-2 text-gray text-base">
                Your trusted real estate partner in the Philippines. We help you find, buy, sell, and rent properties with ease.
              </p>
        ...
        <div className="container flex flex-col lg:flex-row justify-between items-center mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="lg:max-w-45 max-w-full text-center lg:text-left mb-4 lg:mb-0">
            <div className="flex lg:flex-nowrap flex-wrap lg:flex-row lg:gap-11 gap-4 text-base sm:text-lg md:text-xl text-black text-opacity-50">
              <p className="text-white">
                Phone :
                <Link href="tel:+639758868962" className="text-gray hover:text-white"> +63 975 886 8962</Link>
              </p>
              <p className="text-white">
                Email :
                <Link href="mailto:venjeberonio@gmail.com" className="text-gray hover:text-white"> venjeberonio@gmail.com</Link>
              </p>
            </div>
          </div>
          <div className="max-w-lg w-full">
            <div className="flex justify-center lg:justify-end">
              ...
              />
              <button className="py-2 px-5 sm:px-9 bg-primary text-base text-white rounded-r-lg hover:bg-emerald-700">
                Subscribe
              </button>
            </div>
          </div>
      ...
      <div className="border-t border-emerald-900/50 py-4 text-center">
        <p className="text-gray text-sm">© 2025 Venje Realty. All rights reserved.</p>
      </div>
    </footer>
  );
};
